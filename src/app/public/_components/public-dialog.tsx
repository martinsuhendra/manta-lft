...
const publicDialogShellClassName =
  "gap-0 overflow-hidden border-0 p-0 [&_[data-slot=dialog-close]]:text-white/80 [&_[data-slot=dialog-close]]:top-5 [&_[data-slot=dialog-close]]:right-5 [&_[data-slot=dialog-close]]:hover:text-white [&_[data-slot=dialog-close]]:data-[state=open]:bg-white/10 [&_[data-slot=dialog-close]]:data-[state=open]:text-white";
